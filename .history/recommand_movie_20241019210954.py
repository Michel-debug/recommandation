...
class RecommandMovie:
    ...
    def recommend_movies_user_itemrc(self,top_n=10,k=10):
        ...
        for user_id in user_ids:
            ...
            recommendations = predicted_ratings.sort_values(ascending=False).head(top)
...
if __name__ == '__main__':
    ...
    # RecommandMovie(data_path).evaluate_model_user_based(k=1000)
    RecommandMovie(data_path).evaluate_model_item_based(k=800)