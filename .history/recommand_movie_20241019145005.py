...
class RecommandMovie:
    ...
    @timeit
    def recommend_movies_user_userrc(self,user_id, rating_matrix, user_similarity, top_n=10, k=10):
        # 预测用户对未评分电影的评分
        predicted_ratings = self.predict_ratings_for_user(user_id, self.rating_matrix, user_similarity, k)
