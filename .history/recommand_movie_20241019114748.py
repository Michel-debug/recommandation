...
class RecommandMovie:
    def __init__(self,data_path):
        ...
        self.user_similarity = self.cosi
    ...
    def cosine_similarity_user(self):
        ...
        self.user_similarity = pd.DataFrame(similarity, index=self.rating_matrix.index, columns=self.rating_matrix.index)
    ...
    def item_item_filter_collaborative_rec(self):
        raise NotImplementedError
